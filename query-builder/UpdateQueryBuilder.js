        ...
        if (metadata) {
            EntityMetadata_1.EntityMetadata.createPropertyPath(metadata, valuesSet).forEach(function (propertyPath) {
                ...
                columns.forEach(function (column) {
                    ...
                    else if ((_this.connection.driver instanceof SapDriver_1.SapDriver || _this.connection.driver instanceof AbstractSqliteDriver_1.AbstractSqliteDriver) && value === null) {
